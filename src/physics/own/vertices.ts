...
export class Vertices {
  ...
  constructor(public dots: Point[] = empty, public density: number = 1) {
  ...
  init() {
    ...
    for (let i = 0; i < this.dots.length - 1; i++) {
      ...
      inertia +=
        ...
        this.triangle_area(point_a, point_b, centroid) * this.density * centroid.minus(triangle_centroid).magnitude();
    }
